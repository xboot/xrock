...
static inline void rock_maskrom_write_arm64(struct xrock_ctx_t * ctx, uint64_t addr, void * buf, size_t len, int rc4)
{
	static const uint8_t payload[] = {
		,
		...
		0x01, 0x0c, 0x00, 0xb9, 0x20, 0x03, 0x00, 0x10, 0x81, 0x02, 0x00, 0x58,
		0x1f, 0x00, 0x01, 0xeb, 0xa0, 0x00, 0x00, 0x54, 0x20, 0x02, 0x00, 0x58,
		0x81, 0x02, 0x00, 0x10, 0x22, 0x02, 0x00, 0x58, 0xae, 0xff, 0xff, 0x97,
	...
	uint8_t * tmp = malloc(sizeof(payload) + 16 + len);
	if(tmp)
	{
		memcpy(&tmp[0], &payload[0], sizeof(payload));
		put_unaligned_le64(tmp + sizeof(payload) + 0, addr);
		put_unaligned_le64(tmp + sizeof(payload) + 8, (uint64_t)len);
		memcpy(tmp + sizeof(payload) + 16, buf, len);
		rock_maskrom_upload_memory(ctx, 0x471, tmp, sizeof(payload) + 16 + len, rc4);
		free(tmp);
	}
}
...
void rock_maskrom_write_arm64_progress(struct xrock_ctx_t * ctx, uint64_t addr, void * buf, size_t len, int rc4)
{
	struct progress_t p;
	size_t n;
...
void rock_maskrom_exec_arm64(struct xrock_ctx_t * ctx, uint64_t addr, int rc4)
{
	static uint8_t payload[] = {
		0xdf, 0x3f, 0x03, 0xd5, 0x9f, 0x3f, 0x03, 0xd5, 0x1f, 0x20, 0x03, 0xd5,
		0x0b, 0x00, 0x00, 0x14, 0x88, 0x77, 0x66, 0x55, 0x44, 0x33, 0x22, 0x11,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		...
		0xe1, 0x03, 0x00, 0x91, 0x01, 0x0c, 0x00, 0xb9, 0xe0, 0x03, 0x1f, 0xaa,
		0xe1, 0x03, 0x1f, 0xaa, 0x62, 0xfd, 0xff, 0x58, 0x40, 0x00, 0x1f, 0xd6,
	...
	put_unaligned_le64(&payload[0x10], addr);
	rock_maskrom_upload_memory(ctx, 0x471, payload, sizeof(payload), rc4);
}
